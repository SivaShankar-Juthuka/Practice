...
class Solution {
  public:
    void solve(Node *root, Node* &st, Node* &mid, Node* &last, Node* &prev) {
        if(root == NULL) return;
        
        solve(root->left, st, mid, last, prev);
        ...
        solve(root->right, st, mid, last, prev);
    }
    void correctBST(Node* root) {
        // add code here.
        Node *st = NULL, *mid = NULL, *last = NULL, *prev = NULL;
        
        solve(root, st, mid, last, prev);
        
        if(st and last) swap(st->data, last->data);
        else if(st and mid) swap(st->data, mid->data);
    }
};
